...
namespace BraneScript
{
    ...
    using Identifiable = std::variant<IRNode<IRModule>, IRNode<IRPipeline>, IRNode<IRFunction>>;
    ...
    class Compiler
    {
      ...
      public:
        Option<std::vector<IRModule>> compile(const std::vector<std::shared_ptr<ParsedDocument>>& documents);
